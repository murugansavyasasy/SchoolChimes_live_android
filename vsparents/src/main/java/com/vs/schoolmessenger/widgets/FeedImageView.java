package com.vs.schoolmessenger.widgets;
...
/**
 * Created by voicesnap on 9/2/2016.
 */
...
//     *            ImageLoader that will be used to make the request.
    ...
    private void adjustImageAspect(int bWidth, int bHeight) {
        ...
        params.width = (int) getResources().getDimension(R.dimen.img_width);
        params.height = (int) getResources().getDimension(R.dimen.img_height);
