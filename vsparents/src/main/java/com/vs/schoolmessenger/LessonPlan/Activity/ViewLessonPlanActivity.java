...
public class ViewLessonPlanActivity extends AppCompatActivity {
    ...
    private void getViewLessonPlans() {
        ...
        Call<ViewLessonPlanModel> call = apiService.getViewLessonPlans(String.valueOf(Section_ID), SchoolID, StaffID, String.valueOf(0));
                ...
                try {
                    ...
                    if (response.code() == 200 || response.code() == 201) {
                        ...
                        if (status == 1) {
                            ...
                            mAdapter = new ViewLessonPlanAdapter(ViewlessonDataList, ViewLessonPlanActivity.this,rytParent);
