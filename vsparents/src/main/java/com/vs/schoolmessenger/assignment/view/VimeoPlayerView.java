...
//    }
     ...
     */
    public void initialize(boolean enabledCache, String videoId, String hashKey, String baseUrl) {
        this.videoid = videoId;
     ...
     * @param baseUrl settings embedded url. e.g. https://yourdomain
     */
    public void initialize(boolean enabledCache, String videoId, String baseUrl) {
        this.videoid = videoId;
        this.baseUrl = baseUrl;
     ...
     * @param videoId the video id.
     */
    public void initialize(boolean enabledCache, String videoId) {
        this.videoid = videoId;
