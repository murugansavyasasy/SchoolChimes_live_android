...
public class VimeoPlayer extends WebView {
    ...
    private void initWebView(boolean enabledCache, JsBridge jsBridge, VimeoOptions vimeoOptions, String videoId, String hashKey, String baseUrl) {
...
//        this.loadData(videoId,"text/html","UTF-8");
        if (hashKey != null) {
            videoUrl += "/" + hashKey;
        }
...
//        Log.d("baseurl",baseUrl);
    ...
    protected void initialize(boolean enabledCache, JsBridge jsBridge, VimeoOptions vimeoOptions, String videoId, String hashKey, String baseUrl) {
