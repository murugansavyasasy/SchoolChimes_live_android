...
public class ShowAdvancedNativeAds {
    ...
    public static void getAds(final Activity activity, ImageView image, Slider slider, String Menu_Type, FrameLayout mAdView, ImageView adsClose) {
        stop();
...
//                            google_ad = true;
    ...
    public static void getAdswithoutSlider(final Activity activity,String Menu_Type, FrameLayout mAdView, ImageView adsClose) {
        stop();
        Log.d("Menu_ID", Constants.Menu_ID);
        String baseURL = TeacherUtil_SharedPreference.getReportURL(activity);
        TeacherSchoolsApiClient.changeApiBaseUrl(baseURL);
