...
public class TicketSummary implements Parcelable {
    ...
    public void setCampaign_name(String campaign_name) { this.campaign_name = campaign_name; }
    ...
    public void setMerchant_logo(String merchant_logo) { this.merchant_logo = merchant_logo; }
    public String getAbout_merchant() { return about_merchant; }
    public void setAbout_merchant(String about_merchant) { this.about_merchant = about_merchant; }
    public String getCampaign_type() { return campaign_type; }
    public void setCampaign_type(String campaign_type) { this.campaign_type = campaign_type; }
    public String getOffer_type() { return offer_type; }
    public void setOffer_type(String offer_type) { this.offer_type = offer_type; }
    public int getDiscount() { return discount; }
    public void setDiscount(int discount) { this.discount = discount; }
    public List<String> getTemplate_files() { return template_files; }
    public void setTemplate_files(List<String> template_files) { this.template_files = template_files; }
    public String getThreshold_amount() { return threshold_amount; }
    public void setThreshold_amount(String threshold_amount) { this.threshold_amount = threshold_amount; }
    ...
    public String getExpiry_type() { return expiry_type; }
    public void setExpiry_type(String expiry_type) { this.expiry_type = expiry_type; }
    public String getCoupon_valid_for() { return coupon_valid_for; }
    public void setCoupon_valid_for(String coupon_valid_for) { this.coupon_valid_for = coupon_valid_for; }
    public String getHow_to_use() { return how_to_use; }
    public void setHow_to_use(String how_to_use) { this.how_to_use = how_to_use; }
    public String getTerms_and_conditions() { return terms_and_conditions; }
    public void setTerms_and_conditions(String terms_and_conditions) { this.terms_and_conditions = terms_and_conditions; }
    ...
    public String getCta_url() { return cta_url; }
    public void setCta_url(String cta_url) { this.cta_url = cta_url; }
    public String getOffer_text() { return offer_text; }
    public void setOffer_text(String offer_text) { this.offer_text = offer_text; }
    public List<Location> getLocation_list() { return location_list; }
    public void setLocation_list(List<Location> location_list) { this.location_list = location_list; }
    public String getRedeemed_on() { return redeemed_on; }
    public void setRedeemed_on(String redeemed_on) { this.redeemed_on = redeemed_on; }
    ...
    public void setSource_link(String source_link) { this.source_link = source_link; }
    public String getIndustry_name() { return industry_name; }
    public void setIndustry_name(String industry_name) { this.industry_name = industry_name; }
    ...
    public boolean isCTAvalid() { return isCTAvalid; }
    public void setCTAvalid(boolean CTAvalid) { isCTAvalid = CTAvalid; }
    public String getCTAname() { return CTAname; }
    public void setCTAname(String CTAname) { this.CTAname = CTAname; }
    public String getCTAredirect() { return CTAredirect; }
    public void setCTAredirect(String CTAredirect) { this.CTAredirect = CTAredirect; }
    public String getOffer_to_show() { return offer_to_show; }
    public void setOffer_to_show(String offer_to_show) { this.offer_to_show = offer_to_show; }
