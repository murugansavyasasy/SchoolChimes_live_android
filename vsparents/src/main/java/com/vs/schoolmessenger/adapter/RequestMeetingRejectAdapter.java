...
import com.vs.schoolmessenger.model.RequestMeetingRejectedModel;
...
public class RequestMeetingRejectAdapter extends RecyclerView.Adapter<RequestMeetingRejectAdapter.MyViewHolder> {
    ...
    public RequestMeetingRejectAdapter(List<RequestMeetingRejectedModel> lib_list, Context context) {
        this.lib_list = lib_list;
        this.context = context;
    }

    @Override
    public RequestMeetingRejectAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.request_meeting_school_list, parent, false);
        return new RequestMeetingRejectAdapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(final RequestMeetingRejectAdapter.MyViewHolder holder, final int position) {
        ...
        if (history.getApprovalStatus().equals("0")) {
            ...
            holder.lnrRequestDate.setVisibility(View.GONE);
            holder.lnrDateTime.setVisibility(View.GONE);
