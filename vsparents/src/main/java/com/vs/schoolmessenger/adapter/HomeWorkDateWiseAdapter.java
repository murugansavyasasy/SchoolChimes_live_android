...
public class HomeWorkDateWiseAdapter extends RecyclerView.Adapter<HomeWorkDateWiseAdapter.MyViewHolder> {
    private List<HomeWorkDateWise> lib_list;
    Context context;
    ...
    public HomeWorkDateWiseAdapter(List<HomeWorkDateWise> lib_list, Context context, RelativeLayout parent) {
        this.lib_list = lib_list;
        this.context = context;
        this.rytParent = parent;
    }
    @Override
    public HomeWorkDateWiseAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.home_work_list_item, parent, false);
        return new HomeWorkDateWiseAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final HomeWorkDateWiseAdapter.MyViewHolder holder, final int position) {
        final HomeWorkDateWise data = lib_list.get(position);
        holder.lblTitle.setText(data.getTopic());
        holder.lblContent.setText(data.getContent());
        ...
        holder.rytPDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                downLoadPDF.downloadSampleFile((Activity) context,data.getFilepath().get(0).getPath(),rytParent);
            }
        });
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String path = data.getFilepath().get(0).getPath();
        ...
        holder.img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String path = data.getFilepath().get(1).getPath();
                openPreviewImage(path);
            }
        });
        ...
        holder.img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String path = data.getFilepath().get(2).getPath();
                openPreviewImage(path);
            }
        });
        ...
        holder.img4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String path = data.getFilepath().get(3).getPath();
                openPreviewImage(path);
            }
        });
        ...
        if(data.getFilepath().size() > 0) {
            if (data.getFilepath().get(0).getType().equals("IMAGE")) {
                 ...
                 if(data.getFilepath().size() == 1){
                    ...
                    holder.img4.setVisibility(View.GONE);
                ...
                else if(data.getFilepath().size() == 2){
                     Glide.with(context)
                             .load(data.getFilepath().get(0).getPath())
                             .into(holder.img1);

                     Glide.with(context)
                             .load(data.getFilepath().get(1).getPath())
                             .into(holder.img2);
                 ...
                 else if(data.getFilepath().size() == 3){
                     Glide.with(context)
                             .load(data.getFilepath().get(0).getPath())
                             .into(holder.img1);
                     ...
                     Glide.with(context)
                             .load(data.getFilepath().get(2).getPath())
                             .into(holder.img3);
                 ...
                 else if(data.getFilepath().size() == 4){
                     Glide.with(context)
                             .load(data.getFilepath().get(0).getPath())
                             .into(holder.img1);
                     ...
                     Glide.with(context)
                             .load(data.getFilepath().get(3).getPath())
                             .into(holder.img4);
            ...
            else if (data.getFilepath().get(0).getType().equals("VOICE")){
                holder.rytPDF.setVisibility(View.GONE);
                holder.rytVoice.setVisibility(View.VISIBLE);
                holder.rytImages.setVisibility(View.GONE);
            }

            else if (data.getFilepath().get(0).getType().equals("PDF")){
    ...
    private void fetchAudio(MyViewHolder holder, HomeWorkDateWise data) {
        String audioUrl = data.getFilepath().get(0).getPath();
