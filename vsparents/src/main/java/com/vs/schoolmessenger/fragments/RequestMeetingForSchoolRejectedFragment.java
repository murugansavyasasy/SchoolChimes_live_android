...
import com.vs.schoolmessenger.adapter.RequestMeetingRejectAdapter;
...
public class RequestMeetingForSchoolRejectedFragment extends Fragment {
    ...
    private void getDetails() {
        ...
        jsonObject.addProperty("ApprovalStatus", "2");
                ...
                try {
                    ...
                    if (response.code() == 200 || response.code() == 201) {
                        ...
                        if (js.length() > 0) {
                            ...
                            RequestMeetingRejectedModel datas;
                            for (int i = 0; i < js.length(); i++) {
                                ...
                                if(!ID.equals("0")) {
                                    ...
                                    Log.d("Response1234", "");
                                    datas = new RequestMeetingRejectedModel(id, name, parentcomment, status, staffcomment, date, time, requestedON, approvedOn, cls);
