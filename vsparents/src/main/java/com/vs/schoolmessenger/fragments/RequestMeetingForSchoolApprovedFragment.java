...
import com.vs.schoolmessenger.adapter.RequestMeetingForApprovedAdapter;
...
public class RequestMeetingForSchoolApprovedFragment extends Fragment {
    ...
    private void getDetails() {
        ...
        jsonObject.addProperty("ApprovalStatus", "1");
                ...
                try {
                    ...
                    if (response.code() == 200 || response.code() == 201) {
                        ...
                        if (js.length() > 0) {
                            ...
                            RequestMeetingApprovedModel datas;
                            for (int i = 0; i < js.length(); i++) {
                                ...
                                if(!ID.equals("0")) {
                                    ...
                                    Log.d("Response1234", "");
                                    datas = new RequestMeetingApprovedModel(id, name, parentcomment, status, staffcomment, date, time, requestedON, approvedOn, cls);
