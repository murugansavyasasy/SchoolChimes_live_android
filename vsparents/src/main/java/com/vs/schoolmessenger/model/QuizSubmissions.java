...
public class QuizSubmissions implements Serializable {
    ...
    public QuizSubmissions(int id, int quizId, String question,
                           String aOption, String bOption, String cOption, String dOption,
                           String qImage, String aImage, String bImage, String cImage, String dImage,
                           int mark, String answer, String studentAnswer, String correctAnswer) {
    ...
    public String getaOption() { return aOption; }

    public void setaOption(String aOption) { this.aOption = aOption; }

    public String getbOption() { return bOption; }

    public void setbOption(String bOption) { this.bOption = bOption; }

    public String getcOption() { return cOption; }

    public void setcOption(String cOption) { this.cOption = cOption; }

    public String getdOption() { return dOption; }

    public void setdOption(String dOption) { this.dOption = dOption; }

    public String getqImage() { return qImage; }

    public void setqImage(String qImage) { this.qImage = qImage; }
    ...
    public void setdImage(String dImage) { this.dImage = dImage; }
